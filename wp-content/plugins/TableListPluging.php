...
class Voters extends WP_List_Table {
...
function my_add_menu_items(){
    $hook = add_menu_page( 'Voters', 'Project Voters', 'activate_plugins', 'my_list_test', 'my_render_list_page',"dashicons-groups",
        10);
