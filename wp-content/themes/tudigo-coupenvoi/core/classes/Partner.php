...
class Partner {
    ...
    function register_the_post_type() {
        $labels = array(
            ...
            'add_new' => 'Add ',
            'add_new_item' => "Add a new  $this->post_type_slug",
            'new_item' => "Add $this->post_type_single",
            'edit_item' => $this->post_type_single,
            'view_item' => 'Show ' . $this->post_type_single,
            'all_items' => 'All  ' . $this->post_type_plural,
            'search_items' => 'Find a ' . $this->post_type_single,
            'not_found' => "No one $this->post_type_single found",
            'not_found_in_trash' => "No one $this->post_type_single in the trash."
        );
