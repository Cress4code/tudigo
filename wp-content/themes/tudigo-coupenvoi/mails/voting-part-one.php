...
<table>
    ...
    <tr>
        ...
        <td colspan="3"><img src="<?php echo get_field("site_logo_mail_confirmation_mail", "option") ?>" class="text-center img-responsive"></td>
    ...
    <tr>
        <td colspan="3" class="text-center">
            <br>    <br>
            <a href="<?php echo    $tokenUrl;
             ?>"  class="tudigo-btn">Confirme</a>
            <br>    <br>    <br>    <br>
        </td>
